...
namespace sDEM2100.Beans
{
    class OpQuarter
    {
        ...
        public OpQuarter(object[] clientInfo, string dbName, string plant)
        {
        ...
        public ExecutionResult DoOpreater(int id)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                var dtSource = dqmsSqlOperater.GetOpQuarter(plant, WorkDateConvert.GetWorkDate("QUARTER", 0));
                ...
                if (dtSource != null && dtSource.Rows.Count > 0)
                {
                    ...
                    sWorkDate =string.IsNullOrEmpty(dtSource.Rows[0][1].ToString())?WorkDateConvert.GetWorkDate("QUARTER", 0): dtSource.Rows[0][1].ToString();
