...
namespace sDEM2100.Beans
{
    class OpWeek
    {
        ...
        public OpWeek(object[] clientInfo, string dbName, string plant)
        {
        ...
        public ExecutionResult DoOpreater(int id)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                var dtSource = dqmsSqlOperater.GetOpWeek(plant,WorkDateConvert.GetWorkDate("WEEKLY", -1));

                string sWorkDate = WorkDateConvert.GetWorkDate("WEEKLY", -1), sValue = "0";
