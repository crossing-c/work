...
namespace sDEM2100.Beans
{
    class SvlrrEe
    {
        ...
        public SvlrrEe(object[] clientInfo, string dbName, string plant)
        {
        ...
        public ExecutionResult DoOpreater(int id)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                var dtSource = dqmsSqlOperater.GetSvlrrEe(plant);
                ...
                if (dtSource != null && dtSource.Rows.Count > 0)
                {
                    ...
                    //iniTrend = int.Parse(dt.Rows[0]["trend"].ToString());
                    ...
                    if (dtTmp != null && dtTmp.Rows.Count > 0)
                    {
                        ...
                        //var lastScore = double.Parse(dtTmp.Rows[0]["score"].ToString());
                        //var oldTrend = int.Parse(dtTmp.Rows[0]["trend"].ToString());
